...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title">Deposite</li> <!------------ /.menu-title ----------------->
                    <li class="menu-item-has-children dropdown">
                    ...
                    <li>
                      <a href="widgets.html"> <i class="menu-icon fa fa-print"></i>Indivisual Reports </a>
                    </li>
                    <li>
                      <a href="widgets.html"> <i class="menu-icon fa fa-newspaper-o"></i>Monthly Summary </a>
                    </li>
                </ul>
            </div><!--------- /.navbar-collapse --------->
        </nav>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="images/bp-1.png" alt="Logo"></a>
                ...
                <div class="header-menu">
                    <div class="header-left">
                        ...
                        <div class="dropdown for-notification">
                            ...
                            <div class="dropdown-menu" aria-labelledby="notification">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <i class="fa fa-warning"></i>
                                    <p>Server #4 overloaded.</p>
                                </a>
                                <a class="dropdown-item media" href="#">
                                    <i class="fa fa-warning"></i>
                                    <p>Server #5 overloaded.</p>
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="images/33.jpg" alt="User Avatar">
                        </a>
                            ...
                            <div class="card-body card-block">
                                <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input" placeholder="enter your name" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Email :</label></div>
                                        <div class="col-12 col-md-9"><input type="email" id="email-input" name="email-input" placeholder="Please enter your email" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="password-input" class=" form-control-label">Password :</label></div>
                                        <div class="col-12 col-md-9"><input type="password" id="password-input" name="password-input" placeholder="Please enter a complex password" class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Address :</label></div>
                                        <div class="col-12 col-md-9"><textarea name="textarea-input" id="textarea-input" rows="5" placeholder="Enter your address" class="form-control"></textarea></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="select" class=" form-control-label">Select User :</label></div>
                                        <div class="col-12 col-md-9">
                                            <select name="select" id="select" class="form-control">
                                                <option value="0">Please select Correctly</option>
                                            ...
                                            <div class="form-check">
                                                ...
                                                <div class="radio">
                                                    <label for="radio3" class="form-check-label ">
                                                        <input type="radio" id="radio3" name="radios" value="option3" class="form-check-input">Others
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="file-multiple-input" class=" form-control-label">Photo :</label></div>
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; 2023 Bachelor Point
                    </div>
                    <div class="col-sm-6 text-right">
                        Designed by <a href="https://colorlib.com">SMJ</a>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            // cellPaiChart
            var cellPaiChart = [
                { label: "Other Meal", data: [[1,37]], color: '#5b83de'},
                { label: "Meal Deposite", data: [[1,63]], color: '#00bfa5'}
            ];
